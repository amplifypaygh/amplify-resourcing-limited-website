              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <p className=" text-white/85 leading-relaxed mb-8">
                    Partner with Amplify Resourcing Limited to streamline your operations, elevate your workforce, and scale your business with smart HR, technology, and automation solutions.
                  </p>
